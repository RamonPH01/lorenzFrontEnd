<template>
    <header class="flex justify-between items-center bg-[#372c31] py-4 px-4">
        <router-link to="/" class="no-underline cursor-pointer">
            ...
            >
                ...
                <path
                    ...
                    transform="translate(110.494 87.592)"
                    fill="url(#pattern)"
                ></path>
                <path
                    ...
                    transform="translate(191.998 76.728)"
                    fill="url(#pattern)"
                ></path>
                <path
                    ...
                    transform="translate(306.472 87.809)"
                    fill="url(#pattern)"
                ></path>
                <path
                    ...
                    transform="translate(398.799 88.848)"
                    fill="url(#pattern)"
                ></path>
            </svg>
        </router-link>
        ...
        <router-link :to="buttonTo" class="no-underline">
            <button
                class="bg-red-800 text-[#f1dcc9] px-4 py-2 rounded-lg shadow hover:bg-red-900 transition cursor-pointer"
            >
                <i class="fa-solid fa-user mr-2"></i>
                <span class="ml-2 hidden md:inline">{{ buttonText }}</span>
            </button>
        </router-link>
    </header>
</template>
...
// Reaktives computed Property, das Ziel und Text abhängig von der Route zurückgibt
const buttonText = computed(() =>
    route.path === "/host" ? "Zur Eventübersicht" : "Für Veranstalter",
);
const buttonTo = computed(() => (route.path === "/host" ? "/" : "/host-login"));
</script>
