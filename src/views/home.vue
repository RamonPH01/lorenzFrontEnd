    ...
    <div class="min-h-screen bg-[#372c31] p-6">
      ...
      <header class="flex justify-between items-center mb-10">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="120" height="50"
             viewBox="0 0 695.669 292.221">
          <defs>
            <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0">
              <stop offset="0%" stop-color="#deb699"></stop>
              <stop offset="20%" stop-color="#f7e8d9"></stop>
              <stop offset="40%" stop-color="#ce905e"></stop>
              <stop offset="60%" stop-color="#af8565"></stop>
              <stop offset="80%" stop-color="#f7e8d9"></stop>
              <stop offset="90%" stop-color="#deb699"></stop>
              <stop offset="100%" stop-color="#deb699"></stop>
            </linearGradient>
